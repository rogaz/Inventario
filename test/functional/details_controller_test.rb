...
class DetailsControllerTest < ActionController::TestCase
  ...
  test "should create detail" do
    assert_difference('Detail.count') do
      post :create, detail: { product_id: @detail.product_id, quantity: @detail.quantity, sale_id: @detail.sale_id }
    end
  ...
  test "should update detail" do
    put :update, id: @detail, detail: { product_id: @detail.product_id, quantity: @detail.quantity, sale_id: @detail.sale_id }
    assert_redirected_to detail_path(assigns(:detail))
  end
